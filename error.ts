...
/**
 * This class provides a wrapper for network errors when making requests to Zapier Embed API
 */
export class ZapierEmbedError extends Error {
  /**
   * The response body
   */
